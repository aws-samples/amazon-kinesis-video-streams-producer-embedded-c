...
struct __Payloads {
    ...
    PUINT32 payloadRefOffset;
    PUINT32 payloadRefLength;
#endif
};
...
struct __RtpPacket {
    ...
    int (*onRtpResend)(uint64_t uTimestamp, uint8_t **ppData, size_t *puLen, void *pAppData);
    void *pAppData;
#endif
};
...
#ifdef SUPPORT_SHARE_BUFFER
typedef struct __RtpPacketRef RtpPacketRef;
struct __RtpPacketRef {
    PBYTE pRawPacketHdr;
    UINT32 rawPacketHdrLength;
    PBYTE refAddr;
    UINT32 refOffset;
    UINT32 refLength;

    int (*onRtpResend)(uint8_t **ppData, size_t *puLen, void *pAppData);
    void *pAppData;
};
typedef RtpPacketRef* PRtpPacketRef;
#endif
