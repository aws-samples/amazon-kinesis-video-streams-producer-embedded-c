...
#ifdef SUPPORT_SHARE_BUFFER
            payloadArray.payloadRefOffset[payloadArray.payloadSubLenSize] = payloadArray.currentOffset;
            payloadArray.payloadRefLength[payloadArray.payloadSubLenSize] = payloadLenConsumed;
            payloadArray.currentOffset += payloadLenConsumed;
#endif
        }
