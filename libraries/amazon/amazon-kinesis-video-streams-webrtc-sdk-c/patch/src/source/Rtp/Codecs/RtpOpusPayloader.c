                            ...
                            PUINT32 pPayloadSubLength, PUINT32 pPayloadSubLenSize)
{
    ...
    /* In opus, we always use one RTP packet, so we can assign it's length and offset directly. */
    pPayloadSubLength[1] = 0;               /* payloadRefOffset */
    pPayloadSubLength[2] = opusFrameLength; /* payloadRefLength */
#endif
